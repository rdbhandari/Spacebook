<%@ include file="header.jsp"%>
	...
	<p>These terms and conditions outline the rules and regulations for
		the use of SpaceBook's Website, located at SpaceBook.</p>

	<p>By accessing this website we assume you accept these terms and
		conditions. Do not continue to use SpaceBook if you do not agree to
	...
	<p>We employ the use of cookies. By accessing SpaceBook, you agreed
		to use cookies in agreement with the SpaceBook's Privacy Policy.</p>
	...
	<p>Unless otherwise stated, SpaceBook and/or its licensors own the
		intellectual property rights for all material on SpaceBook. All
		intellectual property rights are reserved. You may access this from
		SpaceBook for your own personal use subjected to restrictions set in
		these terms and conditions.</p>

	<p>You must not:</p>
	<ul>
		<li>Republish material from SpaceBook</li>
		<li>Sell, rent or sub-license material from SpaceBook</li>
		<li>Reproduce, duplicate or copy material from SpaceBook</li>
		<li>Redistribute content from SpaceBook</li>
	</ul>

	<p>
		This Agreement shall begin on the date hereof. Our Terms and
		Conditions were created with the help of the <a
			href="https://www.privacypolicies.com/blog/sample-terms-conditions-template/">Terms
			And Conditions Template</a>.
	</p>

	<p>Parts of this website offer an opportunity for users to post and
		exchange opinions and information in certain areas of the website.
		SpaceBook does not filter, edit, publish or review Comments prior to
		their presence on the website. Comments do not reflect the views and
		opinions of SpaceBook,its agents and/or affiliates. Comments reflect
		the views and opinions of the person who post their views and
		opinions. To the extent permitted by applicable laws, SpaceBook shall
	...
	<p>SpaceBook reserves the right to monitor all Comments and to
	...
	<p>You hereby grant SpaceBook a non-exclusive license to use,
	...
	<p>We will approve link requests from these organizations if we
		...
		visibility of the hyperlink compensates the absence of SpaceBook; and
	...
	<p>If you are one of the organizations listed in paragraph 2 above
		...
		sending an e-mail to SpaceBook. Please include your name, your
	...
	<p>No use of SpaceBook's logo or other artwork will be allowed for
